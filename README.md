...
- ⚡ **5 ejemplos de casos de uso** reales con entradas/salidas
...
**👉 Acceder a Clara 4.0 Professional**: [Página de Producto](#) *(próximamente)*
...
### 1️⃣ Copia el Prompt
Abre [`prompt-community.txt`](prompt-community.txt) y copia todo el contenido.
...
📖 **Lee la [Guía de Inicio Rápido completa](QUICKSTART.md)** para mejores prácticas.
...
**Entrada**:
Clara, analiza los riesgos y oportunidades de implementar IA en la gestión de recursos humanos.
**Clara responde con**:
1. Contexto actual de IA en RRHH
2. Beneficios identificados (automatización, análisis predictivo)
3. Riesgos críticos (sesgos algorítmicos, resistencia al cambio)
...
**Entrada**:
[$P] Clara, diseña un plan para optimizar el flujo de trabajo en mi departamento administrativo de 10 personas.
**Clara genera**:
- Diagnóstico de situación actual
- Mapeo de procesos (BPMN simplificado)
...
### Más Ejemplos
- [Evaluación de viabilidad de proyecto](examples/ejemplo3-proyecto.md)
- [Síntesis de investigación académica](examples/ejemplo4-investigacion.md)
- [Creación de documentación técnica](examples/ejemplo5-documentacion.md)
...
| Modo | Indicador | Descripción | Tiempo típico |
|------|-----------|-------------|---------------|
| **Express** | `[E]` | Respuesta concisa, directa al punto | 30 seg |
| **Estándar** | `[S]` o predeterminado | Balance profundidad/claridad | 1-2 min |
| **Profesional** | `[$P]` o `[C]` | Análisis exhaustivo con todos los protocolos | 3-5 min |

**Ejemplo de uso**:
[E] Clara, ¿qué es un análisis FODA?

[$P] Clara, evalúa 5 plataformas de CRM para mi empresa del sector salud considerando integración, cumplimiento normativo y TCO a 3 años.
👉 [Guía completa de modos](docs/modos-de-uso.md)

---

## 🛠️ Casos de Uso Reales

Clara 4.0 ha sido utilizada exitosamente en:
...
👉 [Ver casos de éxito completos](docs/casos-de-exito.md)
...
- 🔀 **Sugiere mejoras**: Pull requests bienvenidos (ver [CONTRIBUTING.md](CONTRIBUTING.md))
...
- [ ] 10 ejemplos adicionales de casos de uso
- [ ] Video tutoriales de implementación
- [ ] Plantillas descargables (3 básicas)
- [ ] FAQ extendido
